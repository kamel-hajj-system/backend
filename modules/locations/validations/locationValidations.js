...
const createLocation = [
  ...
  body('zoneCenterLat').optional().isFloat({ min: -90, max: 90 }).toFloat(),
  body('zoneCenterLng').optional().isFloat({ min: -180, max: 180 }).toFloat(),
  body('zoneRadiusMeters').optional().isInt({ min: 1, max: 20000 }).toInt(),
